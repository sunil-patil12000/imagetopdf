          ...
          <div className="flex justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-4">
              <button 
                ...
                className={`text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 px-3 py-2 rounded-md text-sm font-medium transition-colors ${activeSection === 'home' ? 'text-blue-600 dark:text-blue-400' : ''}`}
              >
                Home
              </button>
              <button 
                onClick={() => setActiveSection('blog')}
                className={`text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 px-3 py-2 rounded-md text-sm font-medium transition-colors ${activeSection === 'blog' ? 'text-blue-600 dark:text-blue-400' : ''}`}
              >
                Blog
              </button>
              <button 
